# -*- coding: utf-8 -*-
"""translate_qc_aggregate.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Bf7cA37PgSeOuaJSPIAMYSgqIx82fgKO
"""
  ...
  for i, worker_id in enumerate(worker_ids):
    if worker_id == top_worker_id:
      for j in range(1, num_inputs+1):
        ...
        transcription = mturk_res[f'Input.input_{j}_transcription'][i]
        aggregated_results.append((transcription, worker_ans))
...
def main():
  mturk_res = pd.read_csv('data/translate/sample_output_translate.csv')
  ...
  for i in range(1, num_qcs+1):
    with open(f'data/translate/qc_output_{i}_check.rtf', 'r') as file:
      rtf = file.read()
  ...
  with open('translate_aggregated_output.csv','w') as output_file:
